#!/bin/sh
# Recipe: libXrender — X Rendering Extension client library

NAME="libXrender"
VERSION="0.9.12"
DESCRIPTION="X Rendering Extension client library"
SOURCE_URL="https://www.x.org/archive/individual/lib/libXrender-${VERSION}.tar.gz"
SOURCE_SHA256=""
...
build() {
    ...
    XPROTO_SRC="/tmp/lot-build/libXrender-xorgproto"
    ...
    DEPS_PREFIX="/tmp/lot-build/libXrender-deps-prefix"
    rm -rf "$DEPS_PREFIX"
