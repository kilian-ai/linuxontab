...
# DISABLED WASM workarounds (root cause fixed via --global-base): [WASM workaround: frozen _wrap minimal attrs v22] [WASM workaround: _spec_from_module dict probes v27] [WASM workaround: _init_module_attrs dict probes v28] [WASM workaround: _fix_up_module dict probes v29] [WASM workaround: _resolve_filename dict probes v30] [WASM workaround: spec_from_loader dict probes v31] [WASM workaround: _load_unlocked exec probe v32] [WASM workaround: module_from_spec probe v33] [WASM workaround: module_from_spec minimal v34] [WASM workaround: _setup builtin wiring v35] [WASM workaround: _get_module_lock dummy map v39] [WASM workaround: skip external importers v40]
